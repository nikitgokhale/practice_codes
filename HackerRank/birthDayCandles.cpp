 ...
 * be able to blow out the tallest of the candles. Count how many candles are tallest.
 * Example
...
int birthdayCakeCandles(vector<int> candles) {
    // Approach
    // Check for the maximum element in the array and 
    // check for the count of the maximum element in that array.
    int size = candles.size();
    int max = INT_MIN;
    int count = 0;
    // Searching for the maximum element in the array
